#!/gnuplot
file1="10MeV_2um_angle_elettroni.txt"
fileout_eps="10MeV_2um_angle_elettroni.eps"
fileout_png="10MeV_2um_angle_elettroni.png"
...
#set logscale y
plot file1 u (($3+$4)*0.5):5 w histeps lt 1 lc rgb "blue" lw 3 t 'delta eletrons spectrum'
